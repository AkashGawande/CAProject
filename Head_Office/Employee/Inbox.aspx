<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Office/Employee/EmployeeMasterPage.master" AutoEventWireup="true" CodeFile="Inbox.aspx.cs" Inherits="Staff_Inbox" %>
                                                ...
                                                <div class="row" style="margin-top:10px;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-7 col-md-7 col-sm-7">
                                                            <span class="input-icon">                                                                
                                                                <select name="ddaugender" id="ddlFirmName" class="abc FirmName multiselect validate[required] form-control" multiple="" style="">
                                                                </select>
                                                                </span>
                                                        </div>
                                                    </div>
