...
public partial class Head_Office_ITNoticeCompliance : System.Web.UI.Page
{
    ...
    public static ITFiles[] BindAssignedTo()
    {
        ...
        string str = "";
        str += "SELECT DISTINCT(im.AssignedTo),em.EmpName FROM itnoticemaster im ";
    ...
    public static ITFiles[] GetITFiles(string FranchiseeID, string StartDate, string EndDate, string AssignedTo, string SearchText, string FileStatus)
    {
        ...
        if (FileStatus == "New" && StartDate == "" && EndDate == "")
        {
            ...
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') ORDER BY im.AssignedDate DESC";
        }
        else if (FileStatus == "New" && StartDate != "" && EndDate != "")
        {
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND ";
        ...
        else if (FileStatus == "Assigned" && StartDate == "" && EndDate == "")
        {
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND im.FileStatus LIKE '%Assigned%' ORDER BY im.AssignedDate DESC";
        }
        else if (FileStatus == "Assigned" && StartDate != "" && EndDate != "")
        {
            str += "SELECT im.*,pm.*,em.EmpName,fs.Email FROM itnoticemaster im ";
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND im.FileStatus LIKE '%Assigned%' AND ";
        ...
        else if (FileStatus == "Verified" && StartDate == "" && EndDate == "")
        {
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND im.FileStatus LIKE '%Verified%' ORDER BY im.VerifiedDate DESC";
        }
        else if (FileStatus == "Verified" && StartDate != "" && EndDate != "")
        {
            str += "SELECT im.*,pm.*,em.EmpName,fs.Email FROM itnoticemaster im ";
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND im.FileStatus LIKE '%Verified%' AND ";
        ...
        else if (FileStatus == "Completed" && StartDate == "" && EndDate == "")
        {
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND im.FileStatus LIKE '%Completed%' ORDER BY im.CompletedDate DESC";
        }
        else if (FileStatus == "Completed" && StartDate != "" && EndDate != "")
        {
            str += "SELECT im.*,pm.*,em.EmpName,fs.Email FROM itnoticemaster im ";
            ...
            str += "(im.FranchiseeID like '%" + SearchText + "%' or YearType like '%" + SearchText + "%' or ";
            str += "Year like '%" + SearchText + "%' or ApplicantName like '%" + SearchText + "%' or ApplicantMobileNo like '%" + SearchText + "%' or ";
            str += "ApplicantAddress like '%" + SearchText + "%' or EmpName like '%" + SearchText + "%') AND im.FileStatus LIKE '%Completed%' AND ";
