...
public partial class Head_Office_GSTRegistartionList : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static GSTRegistrationList[] GetGSTRegTP(string StaffId)
    {
        HeadOfficeController Contl = new HeadOfficeController();
        string str = "";
        str += "SELECT * from gstregistrationmaster where FranchiseeID='" + HttpContext.Current.Session["FranchiseeID"].ToString() + "' and StaffID='" + StaffId + "' and Status='InActive' and GSTType='TAX_Payer' order by ReferenceId desc";
    ...
    [WebMethod]
    public static GSTRegistrationList[] GetGSTRegTD(string StaffId)
    {
        HeadOfficeController Contl = new HeadOfficeController();
        string str = "";
        str += "SELECT * from gstregistrationmaster where FranchiseeID='" + HttpContext.Current.Session["FranchiseeID"].ToString() + "' and StaffID='" + StaffId + "' and Status='InActive' and GSTType='TAX_Deductor' order by ReferenceId desc";
