...
$(document).ready(function () {
    ActiveClass("Client");
    //===================================Start TDS Clients DDL Change=============================
    $('#ddlTDSEmployeeID').change(function () {
        $('#ddlTDSEmployeeName').val($('#ddlTDSEmployeeID').val());
        GetTDSClientsDetails($('#ddlTDSEmployeeID').val());
        $('#tblTDSClient').show();
    });
    //===================================End TDS Clients DDL Change=============================

    //===================================Start TDS Clients DDL Change============================
    $('#ddlTDSEmployeeName').change(function () {
        $('#ddlTDSEmployeeID').val($('#ddlTDSEmployeeName').val());
        GetTDSClientsDetails($('#ddlTDSEmployeeName').val());
        $('#tblTDSClient').show();
    });
    //===================================End TDS Clients DDL Change=============================
...
function GetTDSClientsDetails(SID) {
