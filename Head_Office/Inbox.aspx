<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Office/HeadOfficeMaster.master" AutoEventWireup="true" CodeFile="Inbox.aspx.cs" Inherits="Staff_Inbox" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  <link rel="stylesheet" href="../assets/css/bootstrap-duallistbox.min.css" />
    ...
    <script src="HO_JS/Inbox.js"></script>
    <style>
                                                ...
                                                <table class="table table-striped  table-hover" id="dataTables-example2">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center; display: none;">MSg_ID</th>
                                                            <%--<th style="text-align: center; width: 20%">From</th>--%>
                                                            <th style="text-align: center; width: 25%">To</th>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-7 col-md-7 col-sm-7">
                                                            <span class="input-icon">
                                                               ...
                                                               --%> 
                                                                <select name="ddaugender" id="ddlFirmName" class="FirmName multiselect validate[required] form-control" multiple="" style="">
                                                                </select>
