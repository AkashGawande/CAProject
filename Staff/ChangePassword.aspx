<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/StaffMaster.master" AutoEventWireup="true" CodeFile="ChangePassword.aspx.cs" Inherits="Franchisee_ChangePassword" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script src="../assets/js/jquery-2.1.4.min.js"></script>
    <script src="Staff_JS/ChangePassword.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="loaderChangePass" class="loader" style="display:none;"></div>
                                                                                                ...
                                                                                                <div id="collapseOne" class="accordion-body collapse in body">
                                                                                                    <form action="#" class="form-horizontal" id="block-validate">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            ...
                                                                                                            <div class="col-lg-4">
                                                                                                                <input type="password" id="confirm_password2" name="confirm_password2" onblur="CheckPassword()" <%--onkeyup="CheckPasswordONKeyup()"--%> placeholder="Confirm New Password" class="form-control" />
                                                                                                                <label id="ErrorMessage" style="margin-top: 6px; display: none; font-size: 15px; color: red; font-family: cursive">Password mismatch</label>
                                                                                                            </div>
                                                                                                        </div>
