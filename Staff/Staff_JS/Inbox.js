...
$(document).ready(function () {
    ...
    $('#GoToSendMessageDetails').click(function () {
        ...
        GetSentMessages();
        //$('.Deletebtn').attr('id', 'deletesentmsg');
    ...
    $('#ComposeMsg').click(function () {
        BindAdminDrop($('#ddlAdminName'), "Inbox.aspx/BindAdminName");
    ...
    $('#SendMsg').click(function () {
        ...
        var data = "";
        var url = "";
        url = "Inbox.aspx/GetSessionStatus";
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.d != "Record Not Added ..?") {
                                ...
                                $("#ddlAdminName").val("");
                                $("#ddlAdminName").multiselect("refresh");
                                $('#Subject').val("");
                                $('#Message').val("");
                                $('#tblSendmsgAttach tr').remove();
                                AddAttachmentRow();
    ...
    $('#chkdeleteallInbox').change(function () {
        ...
        if ($("#chkdeleteallInbox").is(":checked")) {
            ...
            //$('.Deletebtn').attr('id', 'deleteInboxmsg');
        ...
        success: function (response) {
            $.each(response.d, function (index, value) {
                ...
                var rows = "<tr class='Inbox' style='background-color: white;'>"
                   // + "<td class='customertd' style='text-align:center'><a id='btnDeleteMSg' style='width:30px;height:40px;' ><i class='ace-icon fa fa-trash-o fa-2x'></i></a></td>"
                ...
                + "<td class='customertd' style='text-align:center'><span class='sender' ><i class='message-star ace-icon fa fa-user orange2'></i>" + value.Sender_Name + "</span></td>"
                if (value.Status == "UnRead") {
                    countunread = countunread + 1;
                    rows += "<td class='customertd' style='text-align:center'>" + '<div class="message-item message-unread" style="background-color: transparent;border: 0px solid #EAEDF1;" ><span class="summary"><span class="badge badge-pink mail-tag"></span>&nbsp;&nbsp;&nbsp;<span class="text" id="OpenMessage">"' + value.Subject + '"</span></span></div>' + "</td>"
                }
                else {
                    rows += "<td class='customertd' style='text-align:center'><div class='message-item' style='background-color:transparent;border: 0px solid #EAEDF1;'><span class='summary'><span class='badge badge-success mail-tag' ></span>&nbsp;&nbsp;&nbsp;<span class='text' id='OpenMessage'>" + value.Subject + "</span></span></div></td>"
                }
        ...
        success: function (response) {
            $.each(response.d, function (index, value) {
               ...
               + "<td class='customertd' style='text-align:center;Display:none'>" + count1 + "</td>"
                + "<td class='customertd' style='Display:none'>" + value.MessageID + "</td>"
                + "<td class='customertd' style='text-align:center'><span class='sender' ><i class='message-star ace-icon fa fa-user orange2'></i>" + value.Receiver + "</span></td>"
                if (value.FileName != "" && value.Count != 0) {
                    rows += "<td class='customertd' style='text-align:center'><div class='message-item' style='background-color:transparent;border: 0px solid #EAEDF1;'><span class='summary'><span class='badge badge-success mail-tag' ></span>&nbsp;&nbsp;&nbsp;<span class='text' id='OpenSendMessage'>" + value.Subject + "&nbsp;&nbsp;&nbsp;&nbsp;<a id='showsendattach' title='" + value.Count + " Attachments' href='#'><i  class='ace-icon fa fa-paperclip fa-3x bigger-150'></i></a></span></span></div></td>"
                }
                else {
                    rows += "<td class='customertd' style='text-align:center'><div class='message-item' style='background-color:transparent;border: 0px solid #EAEDF1;'><span class='summary'><span class='badge badge-success mail-tag' ></span>&nbsp;&nbsp;&nbsp;<span class='text' id='OpenSendMessage'>" + value.Subject + "</span></span></div></td>"
                }
                rows += "<td class='customertd' style='text-align:center'><span class='text'>" + value.Date_Time + "</span></td>"
                if (value.Status == "UnRead") {
...
function BindAdminDrop(dept, customUrlIT) {
    $('#ddlAdminName option').remove();
    $.ajax({
        type: "POST",
        url: customUrlIT,
        data: '{}',
