...
$(document).ready(function () {
    ...
    $('#ddlGSTType1').change(function () {    

        if ($('#ddlGSTType1').val() == "TAX_Payer") {
                    GetGSTTAXPayer();
                    $('#tblGSTaxPayer').show();
                    $('#tblGSTaxDeductor').hide();
                } else if ($('#ddlGSTType1').val() == "TAX_Deductor") {
                    GetGSTTAXDeductor();
                    $('#tblGSTaxDeductor').show();
                    $('#tblGSTaxPayer').hide();
                } else  if ($('#ddlGSTType1').val() == "0")
                {
                    $('#tblGSTaxDeductorList tr').remove();
                    $('#tblGSTaxPayer tr').remove();
                    $('#tblGSTaxDeductor').hide();
                     $('#tblGSTaxPayer').hide();
    ...
    //=======================Start Save Update or Add New GSTD  Document =============================
    $('#btnGSTDUploadChange').click(function () {
        
        if ($('#GSTDtxtDocumentName').val() != "") {
            if ($('#GSTDFileChangePhotoSource').val() != "" && $('#GSTDFileChangePhotoFileName').val() != "") {
    ...
    //=======================End Save Update or Add New GSTD Document =============================
...
function GetGSTTAXPayer() {
    $('#tblGSTaxPayerList tr').remove();
    var count = 0;
    var data = "";
    $.ajax({
        type: "POST",
        url: "ClientRegistration.aspx/GetGSTaxPayerList",
        data: data,
...
function GetGSTTAXDeductor(SID) {
    ...
    $.ajax({
        type: "POST",
        url: "ClientRegistration.aspx/GetGSTaxDeductorList",
        data: data,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (r) {
...
function ViewGSTP(ClientID) {
    ...
    $('#tblGSTPFooter tr').remove();
    var count = 0;
    var data = '{ClientID:"' + ClientID + '"}';

    $.ajax({
        type: "post",
        url: "ClientRegistration.aspx/ViewGSTPModelBox",
        data: data,
        ...
        success: function (response) {
            $.each(response.d, function (index, value) {
                ...
                if (a == "") {
                    ...
                    if (getExtension(value.DocumentPath) == "pdf") {
                        rows += "<td class='customertd'><label id='GSTPdocumentId' style='display:none;'>" + value.DocumentId + "</label><a id='Downloadpdf' onClick='openTab(this)' name='" + value.DocumentPath + "' href='#'><img src='../Logo/pdf-icon.png' height='50' width='50' /></a>&nbsp;<a id='btnGSTPchange' href='#' data-toggle='modal' data-target='#ChangeGSTPDocument'>Change</a></td>";
                    } else {
                        rows += "<td class='customertd'><label id='GSTPdocumentId' style='display:none;'>" + value.DocumentId + "</label><img id='myImg' src='" + value.DocumentPath + "' width='50' height='50' data-toggle='modal' data-target='#myImgModal' style='cursor:zoom-in;' data-id='" + value.DocumentPath + "' />&nbsp;<a id='btnGSTPchange' href='#' data-toggle='modal' data-target='#ChangeGSTPDocument'>Change</a></td>";
                    }
                    + "</tr>"
                    ...
                    var rows2 = "";
                    if (getExtension(value.DocumentPath) == "pdf") {
                        rows2 += "<label id='GSTPdocumentId' style='display:none;'>" + value.DocumentId + "</label><a id='Downloadpdf' onClick='openTab(this)' name='" + value.DocumentPath + "' href='#'><img src='../Logo/pdf-icon.png' height='50' width='50' /></a>&nbsp;<a id='btnGSTPchange' href='#' data-toggle='modal' data-target='#ChangeGSTPDocument'>Change</a>";
                    } else {
                        rows2 += "<label id='GSTPdocumentId' style='display:none;'>" + value.DocumentId + "</label><img id='myImg' src='" + value.DocumentPath + "' width='50' height='50' data-toggle='modal' data-target='#myImgModal' style='cursor:zoom-in;' data-id='" + value.DocumentPath + "' />&nbsp;<a id='btnGSTPchange' href='#' data-toggle='modal' data-target='#ChangeGSTPDocument'>Change</a>";
                    }
            ...
            var footer_rows = "<tr><td colspan='" + count + "' style='text-align:right;'><a class='btn btn-sm' id='btnGSTPAddDocument' href='#' data-toggle='modal' data-target='#ChangeGSTPDocument'><i class='fa fa-plus '></i> Upload New Documents</a></td></tr>";
            $('#tblGSTPFooter').append(footer_rows);
...
function ViewGSTD(ClientID) {
    ...
    $.ajax({
        type: "post",
        url: "ClientRegistration.aspx/ViewGSTDModelBox",
        data: data,
        contentType: "application/json",
        dataType: "json",
...
function ViewGSTDDoc(ClientID) {
    ...
    $("#tblGSTDFooter tr").remove();
    var count = 0;
    var data = '{ClientID:"' + ClientID + '"}';

    $.ajax({
        type: "post",
        url: "ClientRegistration.aspx/ViewGSTDDocumentsModelBox",
        data: data,
        contentType: "application/json",
        dataType: "json",
        ...
        success: function (response) {
            $.each(response.d, function (index, value) {
                ...
                if (a == "") {
                    ...
                    + "<tr>"
                    if (getExtension(value.DocumentPath) == "pdf") {
                        rows += "<td class='customertd'><label id='GSTDdocumentId' style='display:none;'>" + value.DocumentId + "</label><a id='Downloadpdf' onClick='openTab(this)' name='" + value.DocumentPath + "' href='#'><img src='../Logo/pdf-icon.png' height='50' width='50' /></a>&nbsp;<a id='btnGSTDchange' href='#' data-toggle='modal' data-target='#ChangeGSTDDocument'>Change</a></td>";
                    } else {
                        rows += "<td class='customertd'><label id='GSTDdocumentId' style='display:none;'>" + value.DocumentId + "</label><img id='myImg' src='" + value.DocumentPath + "' width='50' height='50' data-toggle='modal' data-target='#myImgModal' style='cursor:zoom-in;' data-id='" + value.DocumentPath + "' />&nbsp;<a id='btnGSTDchange' href='#' data-toggle='modal' data-target='#ChangeGSTDDocument'>Change</a></td>";
                    }
                    + "</tr>"
                    ...
                    var rows2 = "";
                    if (getExtension(value.DocumentPath) == "pdf") {
                        rows2 += "<label id='GSTDdocumentId' style='display:none;'>" + value.DocumentId + "</label><a id='Downloadpdf' onClick='openTab(this)' name='" + value.DocumentPath + "' href='#'><img src='../Logo/pdf-icon.png' height='50' width='50' /></a>&nbsp;<a id='btnGSTDchange' href='#' data-toggle='modal' data-target='#ChangeGSTDDocument'>Change</a>";
                    } else {
                        rows2 += "<label id='GSTDdocumentId' style='display:none;'>" + value.DocumentId + "</label><img id='myImg' src='" + value.DocumentPath + "' width='50' height='50' data-toggle='modal' data-target='#myImgModal' style='cursor:zoom-in;' data-id='" + value.DocumentPath + "' />&nbsp;<a id='btnGSTDchange' href='#' data-toggle='modal' data-target='#ChangeGSTDDocument'>Change</a>";
                    }
                    $('#tblGSTDDocuments tr:last td:nth-child(' + count + ')').append(rows2);
                }
            });
            var footer_rows = "<tr><td colspan='" + count + "' style='text-align:right;'><a class='btn btn-sm' id='btnGSTDAddDocument' href='#' data-toggle='modal' data-target='#ChangeGSTDDocument'><i class='fa fa-plus '></i> Upload New Documents</a></td></tr>";
            $('#tblGSTDFooter').append(footer_rows);
...
function GSTPUpdate() {
    ...
    url = "ClientRegistration.aspx/UpdateGSTPClientMasterData";
...
function GSTDUpdate() {
    ...
    url = "ClientRegistration.aspx/UpdateGSTDClientMasterData";
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.d != "Record Not Added ..?") {
                    ...
                    var GSTDContactPersoneDetails = JSON.stringify(GetGSTDBasedContactPersoneDetailsUpdate());
                    $.ajax({
                        url: 'ClientRegistration.aspx/UpdateGSTDClientDetails',
                        type: 'POST',
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8',
...
function GetGSTDBasedContactPersoneDetailsUpdate() {
...
$(document).on('click', '#btnGSTPchange', function () {
    ...
    //var ClientID = $row.find("td:nth-child(3)").text();
    UpdateDocumentId = $row.find("#GSTPdocumentId").text();
    ...
    ClientId = $('#txtGSTPClientID').val();

    UpdatePhotoSource = "";
    UpdateFileName = "";
    $('#GSTPtxtDocumentName').val("");
    $('#GSTPFileChangePhotoSource').val("");
    $('#GSTPFileChangePhotoFileName').val("");
...
//=======================Start Add New GSTP Document Document =============================
$(document).on('click', '#btnGSTPAddDocument', function () {
    ...
    $('#GSTPFileChangePhotoFileName').val("");
    ClientId = $('#txtGSTPClientID').val();
    $('#btnGSTPupload').val("Submit");

});
//=======================End Add New GSTP Document Document=============================
...
function UpdateOrAddGSTPNewDocument() {
    ...
    UpdateFileName = $('#GSTPFileChangePhotoFileName').val();
    ...
    url = "ClientRegistration.aspx/Update_AddGSTPDocument";
    $.ajax({
        url: url,
        type: 'POST',
        dataType: 'json',
...
$(document).on('click', '#btnGSTDchange', function () {
    ...
    var $row = $(this).closest("td");
    //var ClientID = $row.find("td:nth-child(3)").text();
    UpdateDocumentId = $row.find("#GSTDdocumentId").text();
    if ($row.find("#myImg").attr('src')) {
        Imgsrc = $row.find("#myImg").attr('src');
    }
    if ($row.find("#Downloadpdf").attr('name')) {
    ...
    ClientId = $('#txtGSTDClientID').val();

    UpdatePhotoSource = "";
    UpdateFileName = "";
    $('#GSTDtxtDocumentName').val("");
    $('#GSTDFileChangePhotoSource').val("");
    $('#GSTDFileChangePhotoFileName').val("");
...
//=======================Start Add New GSTD Document Document =============================
$(document).on('click', '#btnGSTDAddDocument', function () {
    ...
    $('#GSTDFileChangePhotoFileName').val("");
    ClientId = $('#txtGSTDClientID').val();
    $('#btnGSTDupload').val("Submit");

});
//=======================End Add New GSTD Document Document=============================
...
function UpdateOrAddGSTDNewDocument() {   
    ...
    UpdateFileName = $('#GSTDFileChangePhotoFileName').val();
    ...
    url = "ClientRegistration.aspx/Update_AddGSTDDocument";
    $.ajax({
        url: url,
        type: 'POST',
        dataType: 'json',
