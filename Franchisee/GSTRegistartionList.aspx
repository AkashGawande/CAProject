<%@ Page Title="" Language="C#" MasterPageFile="~/Franchisee/FranchiseeMaster.master" AutoEventWireup="true" CodeFile="GSTRegistartionList.aspx.cs" Inherits="Head_Office_GSTRegistartionList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link rel="stylesheet" href="../assets/css/select2.min.css" />
    <script src="../assets/js/jquery-2.1.4.min.js"></script>
    <script src="Franchisee_JS/GSTRegistartionList.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="loaderFrGST" class="loader" style="display:none;"></div>
                                           ...
                                           <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12" style="width:100%;">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                            <select name="ddaugender" id="ddlEmployeeIDTP" class="EmployeeID validate[required] form-control">
                                                            </select>
                                                        </div>
                                                        <label class="control-label col-sm-2">Employee Name</label>
                                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                                            <select name="ddaugender" id="ddlEmployeeNameTP" class="EmployeeName validate[required] form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12" style="width:100%;">
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-2">Employee ID</label>
                                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                                            <select name="ddaugender" id="ddlEmployeeIDTD" class="EmployeeID validate[required] form-control">
                                                            </select>
                                                        </div>
                                                        <label class="control-label col-sm-2">Employee Name</label>
                                                        <div class="col-lg-5 col-md-5 col-sm-5">
                                                            <select name="ddaugender" id="ddlEmployeeNameTD" class="EmployeeName validate[required] form-control">
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div id="divChequeTP" class="row" style="display: none;">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div id="Photocheque">
                                            <img id="ChequePhotoTP" style="height: 50px; width: 50px; cursor: zoom-in;" data-toggle="modal" data-target="#myImgModal" />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <div id="PhotochequeTD">
                                            <img id="ChequePhotoTD" style="height: 50px; width: 50px; cursor: zoom-in;" data-toggle="modal" data-target="#myImgModal" />
                                            <a id="DownloadChequeTD" onclick="openTab(this)" href="#">
                                                <img src="../../Logo/pdf-icon.png" height="50" width="50" /></a>
                                        </div>
                                        <div id="UploadPhotochequeTD">
                                            <input type="file" class="form-control" name="file[]" id="ChequeTD" onchange="ChequeAttachments(this,'ChequeTD')" />
