...
public partial class Staff_Inbox : System.Web.UI.Page
{
    ...
    public static GetMsgFullDetail[] ShowMsg()
    {
        ...
        str += "WHERE MM.StaffId='' AND MM.Receiver_Id Like '%" + HttpContext.Current.Session["FranchiseeID"].ToString() + "%' AND MM.DeleteStatus!='DeletedFromInbox' ";
    ...
    public static GetMsgFullDetail[] ShowSentMsg()
    {
        ...
        str += "WHERE MM.Sender_Id='" + HttpContext.Current.Session["FranchiseeID"].ToString() + "' AND MM.Sender='Franchisee' AND MM.DeleteStatus!='DeletedFromSentBox' ";
        str += "GROUP BY MM.MessageID,MM.FileTransactionID,MM.DateTime,MM.MessageType,MM.FranchiseeID,MM.ClientId,";
    ...
    public static string SendMasterData(string IDs, string Subject, string Message)
    {
        ...
        try
        {
            ...
            str += "values ('" + datetime + "','Direct','" + IDs + "','" + Subject + "','" + Message.Trim() + "','Franchisee','" + HttpContext.Current.Session["FranchiseeID"].ToString() + "','UnRead','Active')";
