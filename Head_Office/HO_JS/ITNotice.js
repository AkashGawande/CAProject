...
$(document).ready(function () {
    ...
    BindFirmName($('#ddlFirmNameNew'), "ITNoticeCompliance.aspx/BindFirmNameNew");
    GetITNoticeFiles("", "", "", "", "", "New");
    ...
    $('#liAssigned').click(function () {
        BindFirmName($('#ddlFirmNameAssigned'), "ITNoticeCompliance.aspx/BindFirmNameAssigned");
        BindAssignedTo($("#ddlAssignedTo"), "ITNoticeCompliance.aspx/BindAssignedTo");
        GetITNoticeFiles("", "", "", "", "", "Assigned");
    });
    //==========================End Assigned Files Tab======================================
    //==========================Start Verified Files Tab======================================
    $('#liVerified').click(function () {
        BindFirmName($('#ddlFirmNameVerified'), "ITNoticeCompliance.aspx/BindFirmNameVerified");
        BindAssignedTo($("#ddlVerifiedBy"), "ITNoticeCompliance.aspx/BindVerifiedBy");

        GetITNoticeFiles("", "", "", "", "", "Verified");
    });
    //==========================End Verified Files Tab======================================
    //==========================Start Verified Files Tab======================================
    $('#liCompleted').click(function () {
        BindFirmName($('#ddlFirmNameCompleted'), "ITNoticeCompliance.aspx/BindFirmNameCompleted");
        BindAssignedTo($("#ddlCompletedBy"), "ITNoticeCompliance.aspx/BindCompletedBy");

        GetITNoticeFiles("", "", "", "", "", "Completed");
    });
    //==========================End Verified Files Tab======================================
    ...
    $('#btnSearchNew').click(function () {
        ...
        GetITNoticeFiles(FirmName, SDate, EDate, AssignedTo, SearchText, "New");
    });
    ...
    $('#btnSearchAssigned').click(function () {
        ...
        GetITNoticeFiles(FirmName, SDate, EDate, AssignedTo, SearchText, "Assigned");
    });
    ...
    $('#btnSearchVerified').click(function () {
        ...
        GetITNoticeFiles(FirmName, SDate, EDate, VerifiedBy, SearchText, "Verified");
    });
    ...
    $('#btnSearchCompleted').click(function () {
        ...
        GetITNoticeFiles(FirmName, SDate, EDate, VerifiedBy, SearchText, "Completed");
    });
...
function GetITNoticeFiles(FID, SDate, EDate, AssignedTo, SearchText, FStatus) {
    $("#loaderHdITN").show();
    //$("#loaderHdITN").fadeOut("slow");
