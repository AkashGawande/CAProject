<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Office/Employee/EmployeeMasterPage.master" AutoEventWireup="true" CodeFile="IncomeTaxFiles.aspx.cs" Inherits="Head_Office_ClientsList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link rel="stylesheet" href="../../assets/css/select2.min.css" />
    <script src="../../assets/js/jquery-2.1.4.min.js"></script>
    <script src="JS/IncomeTaxFiles.js"></script>
                        ...
                        <div class="tabbable">
                             <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab">
                                <li  id="liAssigned" class="active">
                                    <a data-toggle="tab" href="#ITAssigned">Assigned Files</a>
                                </li>
                                <li id="liVerified">
                                    <a data-toggle="tab" href="#ITVerified">Verified Files</a>
                                </li> 
                            </ul>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="tab-content">
                                        <div id="ITAssigned" class="tab-pane in active">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <div class="row">
                                        ...
                                        <div id="ITVerified" class="tab-pane">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-lg-1 col-md-1 col-sm-1 ">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-horizontal">
                        ...
                        <div id="divDueDate" class="row" style="display:none;">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group">
