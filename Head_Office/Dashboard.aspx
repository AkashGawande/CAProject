<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Office/HeadOfficeMaster.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Franchisee_Dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script src="../assets/js/jquery-2.1.4.min.js"></script>
    <script src="HO_JS/Dashboard.js"></script>
    <style>
        .color {
            color: chocolate;
            font-family: cursive;
           ...
           <div class="col-lg-12 col-md-12 col-sm-12" style="width:100%;">
               <div class="form-group">
                   <div class="col-lg-6 col-md-6 col-sm-6">
                       <label class="control-label col-lg-4 col-md-4 col-sm-4 color">Franchisee ID</label>
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-6">
                       <label class="control-label col-lg-4 col-md-4 col-sm-4 color">Firm Name</label>
                       <div class="ccol-lg-8 col-md-8 col-sm-8">
