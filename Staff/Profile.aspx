<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/StaffMaster.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="Staff_Profile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link rel="stylesheet" href="../assets/css/select2.min.css" />
    <script src="../assets/js/jquery-2.1.4.min.js"></script>
    <script src="Staff_JS/Profile.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="loaderStaffProf" class="loader" style="display: none;"></div>
                    ...
                    <div id="home" class="tab-pane in active">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <h4 class="blue">
                                    <span class="middle">
                                        <label id="UserName" style="font-size: 20px" runat="server"><%--Alex M. Doe--%></label></span>
                                ...
                                <div class="profile-user-info">
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <label id="lblempId" runat="server"><%--BIPPG0355Q-1--%></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            ...
                                            <label id="lblPassword" runat="server"><%--BIPPG0355Q-1--%></label>&nbsp;&nbsp;&nbsp;&nbsp;<a href="ChangePassword.aspx" title="Change Password" id="btnchangepassword"><i class="fa fa-edit brown bigger-150"></i></a>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <label id="lblusername" runat="server"><%--alexdoe--%></label>
                                            <input type="text" id="txtUserName" style="height: 25px; width: 300px; display: none;" />
                                            <span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            ...
                                            <label id="lblAddress" runat="server"><%--gdfg--%></label>
                                            <textarea type="text" id="txtAddress" style="height: 50px; width: 300px; display: none;"></textarea>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span>
                                                <label id="lbldob" runat="server"><%--22-05-1992--%></label></span>
                                            <input type="text" id="txtdob" style="height: 25px; width: 150px; display: none;" />
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span>
                                                <label id="lblmobileNo" runat="server"><%--787559488--%></label></span>
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            ...
                                            <input type="text" id="txtEmailId" style="height: 25px; width: 250px; display: none;" />
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span>
                                                <label id="lblGender" runat="server"><%--M--%></label></span>
                                            <select name="ddauGSTType" id="ddlGender" class="Gender validate[required] form-control" style="height: 30px; width: 150px; display: none;">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span>
                                                <label id="lbljoiningDate" runat="server"><%--20-06-2010--%></label></span>
                                        </div>
                                    </div>
                                ...
                                <div class="row ">
                                    <div class="form-group col-lg-10 col-lg-push-1">
                                        <a class="btn btn-xs btn-primary" style="font-size: 14px;" title="Edit Personal Details" id="btneditPersonal"><i class="fa fa-edit white bigger-150"></i>Edit Personal Details</a>
